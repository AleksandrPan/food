				...
				<div className="footer__wrapper">
					...
					<div className="footer__col">
						<div className="contacts">
							<p className="contacts__title">Для связи</p>
							<a className="contacts__tel contacts__link" href="tel:8123456789">
								8 (999) 99-99-99
							</a>
							<a className="contacts__mail contacts__link" href="mailto:hordog.ru@bk.ru">
								foodog.ru@bk.ru
							</a>
